...
public class ProductResourceTests {
	...
	void variaveis() throws Exception {
		...
		//Abordagem usada quando o método não tem retorno
		doNothing().when(service).delete(existingId);
		
		//Abordagem usada quando o método é void e gera um excecção
	...
	@Test
	public void findByIdShouldThrowNotFoundDoesNotIdExists() throws Exception {
	...
	@Test
	public void updateShouldReturnProducWhenIdExists() throws Exception {
	...
	@Test
	public void updateShouldReturnProducWhenDoesNotIdExists() throws Exception {
	...
	@Test
	public void deleteShouldDoNothingWhenDoesNotIdExists() throws Exception {
	...
	@Test
	public void insertShouldProduc() throws Exception {
